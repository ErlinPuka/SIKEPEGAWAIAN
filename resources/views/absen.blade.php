...
<body>
    <div class="container">
        <nav class="sidebar">
            ...
            <ul>
                <li><a href="/dashboard" class="active"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a>
                </li>
                <div class="dropdown">
                ...
                <main class="main-container">
                    <div class="main-title">
                            ...
                            <table class="table-data">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Mariam</td>
                                        <td>
                                            <form><label><input name="check" value="1" type="checkbox"></label>
                                            </form>
                                        </td>
                                        <td>
                                            <form><label><input name="check" value="1" type="checkbox"></label>
                        ...
                        <div class="col card-header text-right">
                            <button type="button" class="btn btn-primary plus" data-bs-toggle="pegawai"
                                data-bs-target="#absenpegawai">
