        ...
        <main>
            ...
            <div class = "cards-categories">
                ...
                <div class="card-categories">
                    <div class="card">
                        <img src="{{ asset('images/coklat_pasta.jpg') }}" alt="Image" height="200"
                            width="200" />
                        <h5>Chocolate Pasta</h5>
                        <p>Chocolate Pasta adalah produk berbentuk pasta yang terbuat dari coklat kental yang mempunyai
                            aroma yang sangat wangi
                        </p>
                    </div>
                    <div class="card">
                        <img src="{{ asset('images/darkcoklat.jpg') }}" alt="Image" height="200" width="200" />
                        <h5>Dark Chocolate</h5>
                        <p>Dark Chocolate adalah coklat yang terbuat dari biji kakao dan diolah tanpa menambahkan susu.
                            itulah mengapa Dark Chocolate mempunyai aroma yang lebih kuat </p>
                    </div>
                    <div class = "card">
                        <img src="{{ asset('images/milkcoklat.jpg') }}" alt="Image" height="200" width="200" />
                        <h5>Milk Chocolate</h5>
                        <p>Milk Chocolate adalah coklat yang mengandung kakao dan susu kental manis atau bubuk susu.
                            Milk Chocolate ini mempunyai tekstur yang sangat lembut</p>
                    </div>
                    <div class = "card">
                        <img src="{{ asset('images/candycoklat.jpg') }}" alt="Image" height="200" width="200" />
                        <h5>Candy Coating Chocolate</h5>
                        <p>Candy Coating Chocolate adalah Produk Permen yang diberi perasa Coklat dan minyak sayur
                            sebagai pengganti mentega kakao</p>
                    </div>
                    <div class = "card">
                        <img src="{{ asset('images/whitecoklat.jpg') }}" alt="Image" height="200" width="200" />
                        <h5>White Chocolate </h5>
                        <p>White Chocolate adalah mengandung mentega kakao setidaknya 20% dan 14% susu dan juga vanila
                            yang memberikan kesan wangi</p>
                    </div>
                </div>
            </div>
        </main>
