                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-vertical" action="{{ route('staf.update', $staf->id_staf) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-body">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="id_jam_kerja" id="id_jam_kerja"
                                                            ...
                                                            @foreach ($jam_kerja as $k)
                                                                <option
                                                                    {{ $k->id_jam_kerja == $jamKerjaExist->id_jam_kerja ? 'selected' : '' }}
                                                                    value="{{ $k->id_jam_kerja }}">
                                                                    {{ $k->jam_kerja }}
                                                                </option>
                                                            @endforeach
                                                        </select>
